...
public static int hideFiles(Data file) throws SQLException, IOException {
    Connection connection = MyConnection.getConnection();
    PreparedStatement ps = connection.prepareStatement("insert into data( name_file, path, email, bin_data) values(?,?,?,?)");
...
public static void unHide(int id) throws SQLException, IOException{
    ...
    ps.setInt(1,id);
    ps.executeUpdate();
    System.out.println("SuccessFully Unhidded the file");
}
}
